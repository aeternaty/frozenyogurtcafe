...
serve(async (req) => {
  ...
  try {
    ...
    const spamKeywords = ['casino', 'bitcoin', 'cryptocurrency', 'viagra', 'loan', 'forex', 'investment', 'click here']
    ...
    if (hasSpam) {
      ...
      return new Response(
        JSON.stringify({ message: 'Thank you for your message! We will get back to you within 24 hours.' }), 
        { 
          status: 200, 
          headers: { ...corsHeaders, 'Content-Type': 'application/json' } 
        }
