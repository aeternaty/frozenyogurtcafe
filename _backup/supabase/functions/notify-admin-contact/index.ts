      ...
      html: `
        <div style="font-family: 'Inter', Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #ffffff;">
          <div style="background: linear-gradient(135deg, #FF8A3D 0%, #FF6B35 100%); padding: 30px; text-align: center; border-radius: 10px 10px 0 0;">
            ...
            <p style="color: rgba(255,255,255,0.9); margin: 10px 0 0 0; font-size: 16px;">New Contact Message Received</p>
          </div>
          ...
          <div style="padding: 40px 30px;">
            <div style="background: linear-gradient(135deg, #f8f9fa 0%, #e9ecef 100%); padding: 25px; border-radius: 12px; margin-bottom: 30px; border-left: 4px solid #FF8A3D;">
              <h2 style="color: #FF8A3D; margin: 0 0 20px 0; font-size: 20px;">Contact Information</h2>
              ...
              <table style="width: 100%; border-collapse: collapse;">
                <tr>
                  ...
                  <td style="padding: 10px 0; border-bottom: 1px solid #dee2e6; text-align: right;">
                    <span style="color: #212529; font-weight: 600;">${record.name}</span>
                  </td>
                </tr>
                <tr>
                  <td style="padding: 10px 0; border-bottom: 1px solid #dee2e6;">
                  ...
                  <td style="padding: 10px 0; border-bottom: 1px solid #dee2e6; text-align: right;">
                    <a href="mailto:${record.email}" style="color: #0066cc; text-decoration: none;">${record.email}</a>
                  </td>
                </tr>
                <tr>
                  ...
                  <td style="padding: 10px 0; text-align: right;">
                    <span style="color: #212529;">${record.subject}</span>
                  </td>
                </tr>
              </table>
            </div>
            
            <div style="background: #d1ecf1; padding: 20px; border-radius: 10px; margin-bottom: 20px; border-left: 4px solid #17a2b8;">
              <h3 style="color: #0c5460; margin: 0 0 10px 0; font-size: 16px;">Message</h3>
