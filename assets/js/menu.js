class DynamicMenuSystem {
    ...
    generateLocationTabs(locations) {
        ...
        locations.forEach((location, index) => {
            ...
            button.className = `location-tab flex-1 py-3 px-4 rounded-full font-medium transition-all duration-200 ${index === 0 ? 'text-white bg-orange-500' : 'text-gray-700'
                }`;
    ...
    updateLocationTabs() {
        document.querySelectorAll('.location-tab').forEach(tab => {
            ...
            tab.className = `location-tab flex-1 py-3 px-4 rounded-full font-medium transition-all duration-200 ${isActive ? 'text-white bg-orange-500' : 'text-gray-700'
                }`;
        });
    }
    ...
    switchTab(tab) {
        ...
        document.querySelectorAll('.menu-tab').forEach(tabBtn => {
            ...
            tabBtn.className = `menu-tab flex-1 py-3 px-4 rounded-full font-medium transition-all duration-200 ${isActive ? 'text-white bg-orange-500' : 'text-gray-700'
                }`;
        });
